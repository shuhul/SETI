...
line_1, =  ax.plot([],[],"o",c='cyan')
line_2, =  ax.plot([],[],"x",c='black')
line_3, =  ax.plot([],[],"*",c='r')
...
def init():
   ...
   time_text.set_text('')
   return line_1,line_2,line_3,line_4,time_text


# 250(1), 409(10), 567(100), 643(300)
def stime(i):
    for j in range(250,567):
...
#         stdr[j]=1.0e3*1.149e13/(np.sqrt(rgrid[j])*3.0*0.5*p)
    ...
    return line_1,line_2,line_3,line_5,line_6,time_text
