...
plt.ylim(ymin,ymax)
plt.ylabel('Time')
plt.title(' cm Dust Surface Density ',fontsize=10)
plt.colorbar()
...
plt.ylim(ymin,ymax)
plt.ylabel('Time')
plt.title(' 400um Dust Surface Density ',fontsize=10)
plt.colorbar()
...
plt.ylim(ymin,ymax)
plt.ylabel('Time')
plt.title(' tiny Dust Surface Density ',fontsize=10)
plt.colorbar()
