...
#define DUST_TRANGE_MAX 1 
     ...
     %                dust_temprange_low,dust_n_catom
      doubleprecision dust_kappawgt_abs(1:FRSIZE_FREQ,
     %           1:DUST_TRANGE_MAX,
     %                    1:DUST_SIZE_MAX,1:DUST_SPECIES_MAX)
      doubleprecision dust_kappawgt_scat(1:FRSIZE_FREQ,
     %     1:DUST_TRANGE_MAX,
     %                    1:DUST_SIZE_MAX,1:DUST_SPECIES_MAX)
     ...
     %                    1:DUST_SPECIES_MAX)
      ...
      doubleprecision dust_n_catom(1:DUST_SPECIES_MAX)
c
      common/dustgrains/dust_agrain,dust_sw
      doubleprecision dust_agrain,dust_sw
c
